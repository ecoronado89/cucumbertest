Feature: Cucumber Mathematics
    ...
    Scenario: Let's eat cucumbers!
        ...
        Then I have 1 cucumbers in my inventory

    Scenario: Let's eat carrots
        Given I have 10 carrots
        When I eat 12 carrots
        Then I have 0 carrots in my inventory
    ...
    Scenario: Let's make a salad
        ...
        Then I have 5 cucumbers in my inventory
        And I have 3 carrots in my inventory
        And I have 1 salad